...
import { buildDeepReading } from './deepReading';
...
function CardReading({entry}){
  return <div className="reading-card reading-card--proper-reading">
    ...
    <div className="reading-card__copy">
      ...
      <p className="reading-card__reading">{entry.reading}</p>
    </div>
  </div>;
}
