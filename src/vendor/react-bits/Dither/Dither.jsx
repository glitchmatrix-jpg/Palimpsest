...
const RetroEffect = forwardRef(({ colorNum, pixelSize, resolution }, ref) => {
  return <WrappedRetro ref={ref} colorNum={colorNum} pixelSize={pixelSize} resolution={resolution} />;
});
RetroEffect.displayName = 'RetroEffect';

function DitheredWaves(props) {
  const {
  ...
  return <>
    ...
    <EffectComposer>
      <RetroEffect colorNum={colorNum} pixelSize={pixelSize} resolution={renderResolution} />
    </EffectComposer>
    <mesh onPointerMove={handlePointerMove} position={[0,0,.01]} scale={[viewport.width,viewport.height,1]} visible={false}>
      <planeGeometry args={[1,1]} />
